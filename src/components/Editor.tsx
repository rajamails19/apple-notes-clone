  ...
  return (
    <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', background: 'var(--bg-editor)' }}>
      ...
      <div
        ...
        style={{ flex: 1, minHeight: 0, overflowX: 'hidden', overflowY: 'auto', paddingBottom: 80, WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', touchAction: 'pan-y pinch-zoom' } as React.CSSProperties}
